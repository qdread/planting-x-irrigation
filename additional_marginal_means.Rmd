...
f2_combined <- plot_grid(f2_top + no_x + theme(plot.margin = unit(c(2, 2, 2, 0), 'mm')), f2_bottom + theme(plot.margin = unit(c(0, 2, 2, 2), 'mm')), nrow = 2, align = 'v', rel_heights = c(1, 1.1), labels = c('a', 'b'), label_fontfamily = 'fgbook')
```
...
f3_combined <- plot_grid(f3_top + no_x + theme(plot.margin = unit(c(2, 2, 2, 0), 'mm')), f3_bottom + theme(plot.margin = unit(c(0, 2, 2, 2), 'mm')), nrow = 2, align = 'v', rel_heights = c(1, 1.07), labels = c('a', 'b'), label_fontfamily = 'fgbook')
```
...
f4_combined <- plot_grid(f4_top + theme(legend.position = c(0.28, 0.83)), f4_bottom + theme(legend.position = 'none'), nrow = 2, align = 'v', labels = c('a', 'b'), label_fontfamily = 'fgbook')

f4_combined_horizontal <- plot_grid(f4_top + theme(legend.position = 'none'), f4_bottom + theme(legend.position = c(0.4, 0.87)), nrow = 1, align = 'h', labels = c('a', 'b'), label_fontfamily = 'fgbook')
```
...
f6_combined <- plot_grid(f6_top + no_x + theme(plot.margin = unit(c(2, 2, 2, 0), 'mm'), legend.position = 'none'), f6_bottom + theme(plot.margin = unit(c(0, 2, 2, 2), 'mm')), nrow = 2, align = 'v', rel_heights = c(1, 1.07), labels = c('a', 'b'), label_fontfamily = 'fgbook')
```
